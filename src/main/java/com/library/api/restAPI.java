...
public class restAPI {
	@Autowired
	BookService bookService; // Inject the BookService bean into this class
	...
	// To get a specific book according to the id provided
	...
	// Updates the book details for the book id provided 
	...
	//Deletes the book of the provided book id
